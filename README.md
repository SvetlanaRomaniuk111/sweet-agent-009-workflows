...
**GitHub:** [sweet-agent-009-workflows](https://github.com/SvetlanaRomaniuk111/sweet-agent-009-workflows)  
...
| 📊 Pitch-презентація | Готово | [Google Drive] (https://drive.google.com/file/d/1XCI4nbKaoIzdHR50yHjeDdGbqONYEA3V/view?usp=sharing) |
...
| Полева Євгенія | Data Analytics — оцінка обсягу ринку, тестування моделі |
| Пилипенко Сергій | Data Analytics — генерація ідеї, стратегічне бачення |
